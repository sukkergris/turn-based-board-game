...
namespace GameEngine
{
   public class ActAction
   {
      ...
      {
         var correctedX = World.CoordinateSystem.AutoCorrectXCoordinate(Helpers.Random() + (int)origin.X.Value);
         var correctedY = World.CoordinateSystem.AutoCorrectYCoordinate(Helpers.Random() + (int)origin.Y.Value);
